...
import { representativeSchema, type RepresentativeData } from "@/lib/validators/schema";
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-10 shadow-sm max-w-5xl mx-auto font-sans">
      <header className="mb-8">
        ...
        <p className="text-sm text-gray-500 mt-1">Dados do responsável legal da empresa</p>
      </header>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          />
          {errors.jobTitle && <p className="text-xs text-red-500 font-medium">{errors.jobTitle.message}</p>}
        </div>

      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-[#249c74] hover:bg-[#249c74] border-none">
            ...
            <TableHead className="p-5 text-[10px] font-black uppercase tracking-widest text-white text-center rounded-tr-[32px] w-[100px]">
              Ações
            </TableHead>
          </TableRow>
        </TableHeader>
        ...
        <TableBody>
          {data.map((item) => (
            ...
            >
              {/* Usando TableCell corretamente agora */}
              <TableCell className="p-5">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-xl bg-slate-50 flex items-center justify-center text-gray-400 group-hover:text-[#10b981] group-hover:bg-emerald-50 transition-all border border-transparent group-hover:border-emerald-100">
                    <Users2 size={18} />
                  </div>
              ...
              <TableCell className="p-5">
                <span
                  className={cn(
                    ...
                    item.status === "Ativo"
                      ? "bg-[#dcfce7] text-[#10b981] border border-emerald-100/50"

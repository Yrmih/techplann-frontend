...
export const Hero = () => {
  return (
    <section className="relative w-full pt-20 pb-20 overflow-hidden bg-[#fdfdfd]">
      {/* Fundo com gradiente suave nas extremidades conforme a foto */}
      <div className="absolute top-0 left-0 w-full h-full -z-10 overflow-hidden">
        <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[60%] rounded-full bg-cyan-100/40 blur-[120px]" />
        <div className="absolute bottom-[10%] right-[-5%] w-[35%] h-[50%] rounded-full bg-emerald-100/40 blur-[120px]" />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 flex flex-col items-center text-center">
        ...
        >
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#10b981] via-[#22d3ee] to-[#10b981] bg-[length:200%_auto] animate-gradient-x">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 mb-12">
          {/* Botão com gradiente conforme a foto */}
          <Link
            href="/onboarding/organization"
            className="group relative bg-gradient-to-r from-[#10b981] to-[#06b6d4] text-white px-10 py-4 rounded-xl font-bold text-lg flex items-center gap-2 hover:opacity-90 hover:scale-105 transition-all shadow-xl shadow-cyan-100/50"
          >
            Começar Teste Grátis
            <MoveRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
          </Link>

          <button className="group flex items-center gap-2 px-8 py-4 rounded-xl font-bold text-lg text-slate-700 bg-white border border-slate-100 hover:bg-slate-50 transition-all shadow-md shadow-slate-100">
            ...
            <div className="bg-[#f8fafc] w-full aspect-[16/9] flex">
              ...
              <div className="flex-1 p-8 text-left flex flex-col gap-6 overflow-hidden">
                ...
                <div className="flex gap-4 flex-1 h-full min-h-0">
                  <div className="flex-[2] bg-white p-6 rounded-2xl border border-slate-100 flex items-end gap-2.5 justify-between relative overflow-hidden text-left">
